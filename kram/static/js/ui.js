...
kram.updateStat = function() {
    ...
    maxDiv.html("<span class='glyphicon " + kram.statStyle[kram.data.max.style].icon + "'></span> " + kram.data.max.value);

    minDiv.removeClass();
    minDiv.addClass(kram.statStyle[kram.data.min.style].color);
    minDiv.html("<span class='glyphicon " + kram.statStyle[kram.data.min.style].icon + "'></span> " + kram.data.min.value);

    meanDiv.removeClass();
    meanDiv.addClass(kram.statStyle[kram.data.mean.style].color);
    meanDiv.html("<span class='glyphicon " + kram.statStyle[kram.data.mean.style].icon + "'></span> " + kram.data.mean.value);
